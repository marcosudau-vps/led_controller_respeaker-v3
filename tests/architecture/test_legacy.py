...
def test_the_scan_actually_covers_the_running_code():
    ...
    assert "packages/led-controller-version-3/src/lefx/engine/runtime.py" in covered
    assert "packages/led-controller-version-3/src/lefx/interfaces/service.py" in covered
